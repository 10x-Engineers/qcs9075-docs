...
![Figure 1-2](images/fig02.png)

```text
Vector context
V0 1024-bitQ0 128-bit
...
128sss
...Q3
sbit
...
The HVX scalar core can contain any number of hardware threads greater or equal to the number of vector contexts. The scalar hardware thread is assignable to a vector context through per-thread SSR:XA programming, as follows:
...
![Figure 1-4](images/fig04.png)

```text
127 126 125 124 7 6 5 4 3 2 1 0 Byte
63 62 3 2 1 0 Halfword
31 1 0 Word
```
...
| `v1:0.b = vadd(v3:2.b, v5:4.b) v1:0.h = vadd(v3:2.h, v5:4.h) // Add vector pairs of halfwords.` | `// Add vector pairs of bytes.` |
| `v5:4.w = vmpy(v0.h,v1.h)` | `// Widening vector 16 x 16 to 32 // multiplies: halfword inputs,` |
| `//` | `word outputs.` |
...
## 1.3 Changes in V73 HVX

The following are updates for V73 HVX:

- Increased intrinsic support for HVX (additional HVX testing)
- Simulator support for 38-bit PA
- Auto-vectorization for IEEE floating point (FP16)

## 1.4 Technical assistance

For assistance or clarification on information in this document, open a technical support case at [https://support.qualcomm.com/](https://support.qualcomm.com/).

You will need to register for a Qualcomm ID account and your company must have support enabled to access our Case system.

Other systems and support resources are listed on [https://qualcomm.com/support](https://qualcomm.com/support).
